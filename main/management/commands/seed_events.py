    ...
    def handle(self, *args, **options):
        ...
        for _ in range(50):
            ...
            branch = random.choice(
                [b for b in branches if b.edu_center == edu_center])
            ...
            price = random.randint(
                10000, 100000) if requirement == 'payed' else None
            ...
            event.picture.save(f"{fake.slug()}.jpg",
                               File(image_temp), save=True)

        self.stdout.write(self.style.SUCCESS(
            "✅ 50 ta Event muvaffaqiyatli yaratildi."))
